export default function ExperienceCard({
  ...
  return (
    <div className="relative w-full pb-6">
      ...
      <div
        className={`relative ml-6 md:ml-0 bg-black/20 px-4 py-3 rounded-lg 
            ${
              side == "right"
      ...
      >
        ...
        <span className="text-secondary text-2xl font-bold mb-1">
          {position}
        </span>
        <h3 className="text-xl font-semibold mb-1 text-gray-200">{company}</h3>
        <p className="text-xl mb-4 text-gray-400 dark:text-gray-400">
          {description}
        </p>
        {children}
      </div>

export default function ExperienceCard({
  ...
  return (
    <div className="relative w-full pb-6">
      <div className="absolute ml-2 lg:ml-0 bg-secondary w-4 h-4 rounded-full top-4 left-0 lg:left-1/2 transform -translate-x-1/2"></div>
      <div
        className={`relative ml-6 lg:ml-0 bg-black/20 p-6
            ${
              side == "right"
      ...
      >
        ...
        <p className="text-lg mb-4 text-gray-400 dark:text-gray-400">
          {description}
        </p>
        {children}
      </div>

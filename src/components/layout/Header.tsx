          ...
          {isOpen && (
            <>
              <motion.div
                ...
                className="fixed inset-0 h-dvh bg-black/50 backdrop-blur-xl z-30 md:hidden"
              />
              <motion.div
                key="mobile-menu"
                initial={{ x: "100%" }}
                ...
                className="fixed top-0 right-0 w-3/4 max-w-xs h-screen bg-[#191919] flex flex-col items-start justify-between px-8 gap-y-6 py-6 md:hidden shadow-lg z-40 pt-20 border-l border-primary"
              >
